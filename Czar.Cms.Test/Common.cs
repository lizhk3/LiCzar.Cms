...
namespace Czar.Cms.Test
{
    public class Common
    {
        ...
        public static IServiceProvider BuildServiceForSqlServer()
        {
            ...
            {
                options.ConnectionString = "Data Source=LAPTOP-DTHUN934\\SQLEXPRESS;User ID=sa;Password=123456;Initial Catalog=CzarCms;Pooling=true;Max Pool Size=50;Min Pool Size=0;Connection Lifetime=300;";
                options.DbType = DatabaseType.SqlServer.ToString();//数据库类型是SqlServer,其他数据类型参照枚举DatabaseType
                options.Author = "lizhk";//作者名称
